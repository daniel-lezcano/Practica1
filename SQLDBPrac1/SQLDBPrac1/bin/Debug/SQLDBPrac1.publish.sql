...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[ALUMNO])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_ALUMNO] ON;
        ...
        FROM     [dbo].[ALUMNO]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_ALUMNO] OFF;
    END
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[APODERADO])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_APODERADO] ON;
        ...
        FROM     [dbo].[APODERADO]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_APODERADO] OFF;
    END
